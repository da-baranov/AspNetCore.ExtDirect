...
namespace AspNetCore.ExtDirect
{
    ...
    internal sealed class ExtDirectHandlerRepository
    {
                                                   ...
                                                   out MethodInfo methodInfo)
        {
            ...
            // Check if method is hidden by the ExtDirectIgnoreAttribute
        ...
        {
            new ExtDirectRemotingApiOptionsValidator()
                .ValidateAndThrow(options);
